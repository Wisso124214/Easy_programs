	...
	do{
		switch(n){
			...
			case 2:
				...
				insertar(p,CrearNodo(CrearMovimiento(modif_saldo,nro_referencia,concepto,CI_beneficiario,nombre_beneficiario,nro_referencia,banco_beneficiario,tlf_beneficiario)));
				break;
